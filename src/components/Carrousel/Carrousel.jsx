...
const Carrousel = ({ slides }) => {
	...
	return (
		<section id="carrousel-container">
			...
			{slides.map((slide, index) => ( // Lancement slider avec affichage conditionnel et opacité quand le slide en cours vaut l'index
				<div
					key={index} 
					className={
						current === index
				...
				>
					{index === current && <img src={slide} alt="Images de logements à louer" />}
					{index === current && (
